...
#ifndef _MONOBLINK_MATRIX_H_
#define _MONOBLINK_MATRIX_H_
...
class Adafruit_DotStar {
 ...
 public:
  ...
  void
    ...
    setHWBrightness(uint8_t),               // Set hardware brighntess(LED drive current)
  ...
  uint8_t
    ...
    getHWBrightness(void) const,            // Return hardware brightness
 ...
 private:
  ...
  uint8_t
    ...
    hwbrightness,                           // Hardware brightness (LED drive current)
